...
adicao = num1 + num2
print("O número {} + {} é: {}" .format(num1, num2, adicao))
...
print("O expoente é: {}" .format(resultado))

# 4 - Faça um programa que converta a temperatura de Celsius para Fahrenheit.

graus = float(input("Digite temperatura em grau Celsius: "))
...
raio = float(input("Digite o raio como entrada: "))
area_circulo = raio ** 2
print("A area do circulo é: {}" .format(area_circulo))
